    ...
    <div className="App">
      <div className="section-1">
        <div className="section-1__nav-bar">
          <p className="section-1__contact">Contact</p>
        </div>
        <div className="section-1__main">
          <div className="section-1__left">
            <h1>
              Custom built <strong>Discord bots</strong><br /> for your server.
            </h1>
            <p>Our team creates <strong>custom Discord bots</strong> to <strong>elevate your server experience</strong>. From <strong>automating tasks</strong> and <strong>moderating chats</strong> to enhancing <strong>community engagement</strong>, our bots are crafted to meet your server's unique needs.</p>
            <button className="join-server" >Join our server</button>
          </div>
          <div className="section-1__right">
            <img className="section-1__img" src="/images/temp-img.png"></img>
          </div>
        </div>
        <div className="section-1__secondary-container">
          <div className="section-1__secondary">
            <div className="section-1__secondary-text">
              ...
              <h1>
                Bring together all the tools you need to 
